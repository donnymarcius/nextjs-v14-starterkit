    ...
    <div>
      ...
      <div className='flex items-start gap-20 p-10'>
        ...
        <div className='flex-row items-center w-full'>
          ...
          <div className='flex items-center w-full gap-4 my-4 px-6'>
            <p className='flex-none w-1/5 font-bold text-green'>Education</p>
            <p className='flex-none w-1/2 border-2 border-green px-2 rounded-lg'>School 1</p>
            <img src='/images/icon/add.png' className='w-6 h-auto bg-green p-1 rounded-md cursor-pointer' alt='add' />
            <img src='/images/icon/remove.png' className='w-6 h-auto bg-green p-1 rounded-md cursor-pointer' alt='remove' />
          </div>

          <div className='flex items-center w-full gap-4 mb-4 px-6'>
            <p className='flex-none w-1/5 font-bold text-green'></p>
            <p className='flex-none w-1/2 border-2 border-green px-2 rounded-lg'>School 2</p>
            <img src='/images/icon/add.png' className='w-6 h-auto bg-green p-1 rounded-md cursor-pointer' alt='add' />
            <img src='/images/icon/remove.png' className='w-6 h-auto bg-green p-1 rounded-md cursor-pointer' alt='remove' />
          </div>

          <div className='flex items-center w-full gap-4 mt-4 px-6'>
            <p className='flex-none w-1/5 font-bold text-green'>Working Experience</p>
            <p className='flex-none w-1/2 border-2 border-green px-2 rounded-lg'>Role 1</p>
            <img src='/images/icon/add.png' className='w-6 h-auto bg-green p-1 rounded-md cursor-pointer' alt='add' />
            <img src='/images/icon/remove.png' className='w-6 h-auto bg-green p-1 rounded-md cursor-pointer' alt='remove' />
          </div>
          ...
          <div className='flex items-center w-full gap-4 mb-4 px-6'>
            <p className='flex-none w-1/5 font-bold text-green'></p>
            <p className='flex-none w-1/2 border-2 border-green px-2 rounded-lg'>Role 2</p>
            <img src='/images/icon/add.png' className='w-6 h-auto bg-green p-1 rounded-md cursor-pointer' alt='add' />
            <img src='/images/icon/remove.png' className='w-6 h-auto bg-green p-1 rounded-md cursor-pointer' alt='remove' />
          </div>
